...
class vistaUi:
    ...
    def ejecutar_entrenamiento(self):
        ...
        try:
            resultado = self.controlador.entrenar_modelo_catergorias(ruta_csv, nombre_modelo, algoritmo)
    ...
    def crear_interfaz_entrenamiento(self):
        ...
        self.combo_algoritmo = ttk.Combobox(self.frame_entrenamiento,
                                            values=["Gradient Boosted Trees", "K-NN", "Naive Bayes"])
        self.combo_algoritmo.grid(row=1, column=1, padx=10, pady=5)
        self.combo_algoritmo.set("Gradient Boosted Trees")
    ...
    def ejecutar_prediccion(self):
        ...
        try:
            resultados = self.controlador.predecir_modelo_clasico(ruta_modelo, ruta_csv)
            resultado_texto = "\n".join(
